    ...
    <footer className="bg-obsidian border-t border-slate-800 text-slate-400 text-sm">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-14 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="flex items-center gap-2 text-xs font-mono text-steelBright bg-slateGraphite/50 border border-slate-800 p-2.5 rounded-lg w-fit">
            <ShieldCheck className="w-4 h-4 text-steelBright" />
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li><Link href="/services/performance-growth" className="hover:text-steelBright transition-colors">Generative Engine SEO</Link></li>
          </ul>
        </div>
        ...
        <div className="space-y-6">
          <div className="space-y-3">
            ...
            <ul className="space-y-2.5 text-xs font-mono">
              <li className="flex items-start gap-2">
                ...
                <span>105 West 28th Street, New York, NY 10001</span>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-steel shrink-0 mt-0.5" />
          ...
          <div className="flex items-center gap-3 pt-2">
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/company/webersol/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="w-9 h-9 rounded-lg bg-slateGraphite/70 border border-slate-800 flex items-center justify-center text-slate-300 hover:text-steelBright hover:border-steelBright/50 transition-all shadow-sm"
            >
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/WeberItSolutions"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="w-9 h-9 rounded-lg bg-slateGraphite/70 border border-slate-800 flex items-center justify-center text-slate-300 hover:text-steelBright hover:border-steelBright/50 transition-all shadow-sm"
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/webitsol/"
              target="_blank"
              rel="noopener noreferrer"
